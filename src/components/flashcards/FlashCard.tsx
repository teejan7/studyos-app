      ...
      >
        ...
        >
          <div>
            ...
            <div className="mt-3 text-lg font-semibold text-green-100">{card.front}</div>
          </div>
        ...
        >
          <div>
            ...
            <div className="mt-3 text-lg font-semibold text-green-100">{card.back}</div>
          </div>
          <button onClick={(event) => { event.stopPropagation(); onToggleMastered(card.id); }} className="rounded-lg border border-border bg-accent px-4 py-2 text-sm font-semibold text-black hover:bg-green-300">
